...
export default async function TeacherPreferencesPage({ searchParams }: { searchParams: { prefs?: string } }) {
  const { supabase, schoolId, userId } = await requireTeacherCtx()
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5 pb-8">
      ...
      <CommPreferencesForm redirectTo="/teacher/preferences" initial={initial} />
    </div>
  )
}
