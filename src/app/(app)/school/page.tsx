...
function NavCard({
  href, label, desc, iconPath,
}: { href: string; label: string; desc: string; iconPath: string }) {
  return (
    <Link
      href={href}
      className="group flex items-start gap-4 rounded-xl border border-sand-200 bg-white px-5 py-4 shadow-sm transition-all hover:border-primary-300 hover:shadow-md"
    >
      <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary-100 text-primary-700 transition-colors group-hover:bg-primary-600 group-hover:text-white">
      ...
      <Icon path={P.chevron} className="ml-auto mt-1 h-4 w-4 shrink-0 text-gray-300 transition-colors group-hover:text-primary-400" />
    </Link>
  )
}
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <NavCard href="/school/students"      label="Élèves"      desc="Dossiers et inscriptions"      iconPath={P.students} />
          <NavCard href="/school/teachers"      label="Enseignants" desc="Corps enseignant"              iconPath={P.teachers} />
          <NavCard href="/school/parents"       label="Parents"     desc="Tuteurs et contacts"           iconPath={P.parents} />
          <NavCard href="/school/classes"       label="Classes"     desc="Classes et effectifs"          iconPath={P.classes} />
          <NavCard href="/school/academics"     label="Académique"  desc="Matières, notes, bulletins"    iconPath={P.academic} />
