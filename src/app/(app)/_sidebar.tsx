...
const P = {
  ...
  copilot:   'M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.456-2.456L14.25 6l1.035-.259a3.375 3.375 0 002.456-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z',
...
const ANALYTICS_ITEM: NavItem = { label: 'Analyses', href: '/school/analytics', iconPath: P.chart }
const COPILOT_ITEM: NavItem = { label: 'Copilot', href: '/school/copilot', iconPath: P.copilot }
...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Élèves à risque',  href: '/school/academic-support',     iconPath: P.alert    },
    ],
  },
  {
    id: 'finance',
  ...
  return (
    <nav className="flex-1 overflow-y-auto px-3 py-4" aria-label="Navigation principale">
      ...
      <div className="pb-1 space-y-1">
        ...
        <NavRow
          item={ANALYTICS_ITEM}
          active={ANALYTICS_ITEM.href === activeHref}
          onClick={onNavigate}
        />
        <NavRow
          item={COPILOT_ITEM}
          active={COPILOT_ITEM.href === activeHref}
          onClick={onNavigate}
        />
      </div>
