  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="bg-white shadow rounded-lg p-6 flex flex-col">
          <h2 className="text-base font-semibold text-gray-900">Factures en retard</h2>
          <p className="mt-1 text-sm text-gray-500 flex-1">
            Notifier les élèves et parents des factures impayées dont l&apos;échéance est dépassée. Sûr à relancer.
          </p>
          <a
            href="/super-admin/jobs/overdue-invoices"
            className="mt-4 self-start inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Ouvrir le job
          </a>
        ...
        <div className="bg-white shadow rounded-lg p-6 flex flex-col">
          <h2 className="text-base font-semibold text-gray-900">Aide</h2>
          <p className="mt-1 text-sm text-gray-500 flex-1">
            Guide intégré du super administrateur : écoles, abonnements, facturation SaaS et audit.
          </p>
          <a
