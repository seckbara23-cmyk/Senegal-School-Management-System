...
const NAV = [
  { label: 'Tableau de bord', href: '/student',               icon: P.home,       exact: true  },
  ...
  { label: 'Aide',            href: '/student/help',          icon: P.help,       exact: false },
]
      ...
      <div className="flex h-16 shrink-0 items-center gap-3 bg-primary-600 px-4">
        ...
        <div className="ml-auto flex items-center">
          <div className="hidden lg:block">
            <NotificationBell unreadCount={unreadCount} items={recent} role="student" variant="dark" align="left" />
          </div>
          <button
    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-30 flex h-14 items-center gap-3 border-b border-primary-600 bg-primary-700 px-4 lg:hidden">
        ...
        <div className="ml-auto">
          <NotificationBell unreadCount={unreadCount} items={recent} role="student" variant="dark" align="right" />
        </div>
      </div>
