...
export default async function ParentAnnouncementDetailPage({ params }: Props) {
  ...
  // Access: all_school / parents, or a class one of the children is enrolled in.
  let allowed = ann.audience_type === 'all_school' || ann.audience_type === 'parents'
  ...
  return (
    <div className="space-y-6 pb-8">
      <div className="rounded-xl bg-primary-800 px-6 py-5">
        <div className="mb-1">
          <a href="/parent/announcements" className="text-primary-300 hover:text-white text-sm">← Annonces</a>
        </div>
